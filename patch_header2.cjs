...
const regex = /\{\/\*\s*Mobile Top Header.*?<div className="md:hidden bg-\[#050E46\] border-b border-slate-800 px-4 py-3 flex items-center justify-between sticky top-0 z-40 shadow-md">.*?<\/div>\s*<\/div>\s*<\/div>/s;
